...
Карел те жељно очекује у свом лавиринту и једва чека да поново заједно сакупљате лоптице!

Пре него што започнете овогодишњу авантуру, подсети се шта си до сада научио о алгоритамском начину размишљања...
...
.. quizq:: 
    ...
    .. mchoice:: p515
        ...
        :answer_d: Карел не може да врши логичке операције
        :feedback_a: Браво, одговор је тачан!
        :feedback_b: Питање је везано за логичке операције, размисли још једном...
        :feedback_c: Одговор није тачан.
        :feedback_d: Нетачно, Карел врши логичке операције, присети се примера од прошле године!
