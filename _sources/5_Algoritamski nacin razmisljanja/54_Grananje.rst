...
Замени (где је потребно) знакове **=** знацима **<** и **>** у програму који је саставио Марко тако да Карел сваки пут направи предвиђени број корака и да стигне до поља (5, 1)
